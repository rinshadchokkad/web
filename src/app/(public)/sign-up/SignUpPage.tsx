      ...
      >
        ...
        <div className="relative z-10 w-full max-w-4xl">
          ...
          <div className="mt-6 text-lg leading-6 tracking-tight text-gray-400">
            ...
            enim consectetur optio maiores, eaque fuga nulla nostrum quos
            officia cupiditate nihil odit et pariatur possimus at dolor
            perferendis tempore accusantium!
          </div>
